#structured + tightly connected model
import numpy as np
...
def INTtoX_DE2(time, solution):
    ...
    I_GPE1_to_GPE7 = g_GPE_to_GPE * (VGPE7 - vGPE_to_GPE) * sGPE1
    I_GPE1_to_GPE8 = g_GPE_to_GPE * (VGPE8 - vGPE_to_GPE) * sGPE1
    I_GPE1_to_GPE9 = g_GPE_to_GPE * (VGPE9 - vGPE_to_GPE) * sGPE1
    I_GPE1_to_GPE2 = g_GPE_to_GPE * (VGPE2 - vGPE_to_GPE) * sGPE1
    I_GPE1_to_GPE3 = g_GPE_to_GPE * (VGPE3 - vGPE_to_GPE) * sGPE1
    I_GPE1_to_GPE4 = g_GPE_to_GPE * (VGPE4 - vGPE_to_GPE) * sGPE1

    I_GPE2_to_GPE8 = g_GPE_to_GPE * (VGPE8 - vGPE_to_GPE) * sGPE2
    I_GPE2_to_GPE9 = g_GPE_to_GPE * (VGPE9 - vGPE_to_GPE) * sGPE2
    I_GPE2_to_GPE1 = g_GPE_to_GPE * (VGPE1 - vGPE_to_GPE) * sGPE2
    I_GPE2_to_GPE3 = g_GPE_to_GPE * (VGPE3 - vGPE_to_GPE) * sGPE2
    I_GPE2_to_GPE4 = g_GPE_to_GPE * (VGPE4 - vGPE_to_GPE) * sGPE2
    I_GPE2_to_GPE5 = g_GPE_to_GPE * (VGPE5 - vGPE_to_GPE) * sGPE2

    I_GPE3_to_GPE9 = g_GPE_to_GPE * (VGPE9 - vGPE_to_GPE) * sGPE3
    I_GPE3_to_GPE1 = g_GPE_to_GPE * (VGPE1 - vGPE_to_GPE) * sGPE3
    I_GPE3_to_GPE2 = g_GPE_to_GPE * (VGPE2 - vGPE_to_GPE) * sGPE3
    I_GPE3_to_GPE4 = g_GPE_to_GPE * (VGPE4 - vGPE_to_GPE) * sGPE3
    I_GPE3_to_GPE5 = g_GPE_to_GPE * (VGPE5 - vGPE_to_GPE) * sGPE3
    I_GPE3_to_GPE6 = g_GPE_to_GPE * (VGPE6 - vGPE_to_GPE) * sGPE3

    I_GPE4_to_GPE1 = g_GPE_to_GPE * (VGPE1 - vGPE_to_GPE) * sGPE4
    I_GPE4_to_GPE2 = g_GPE_to_GPE * (VGPE2 - vGPE_to_GPE) * sGPE4
    I_GPE4_to_GPE3 = g_GPE_to_GPE * (VGPE3 - vGPE_to_GPE) * sGPE4
    I_GPE4_to_GPE5 = g_GPE_to_GPE * (VGPE5 - vGPE_to_GPE) * sGPE4
    I_GPE4_to_GPE6 = g_GPE_to_GPE * (VGPE6 - vGPE_to_GPE) * sGPE4
    I_GPE4_to_GPE7 = g_GPE_to_GPE * (VGPE7 - vGPE_to_GPE) * sGPE4

    I_GPE5_to_GPE2 = g_GPE_to_GPE * (VGPE2 - vGPE_to_GPE) * sGPE5
    I_GPE5_to_GPE3 = g_GPE_to_GPE * (VGPE3 - vGPE_to_GPE) * sGPE5
    I_GPE5_to_GPE4 = g_GPE_to_GPE * (VGPE4 - vGPE_to_GPE) * sGPE5
    I_GPE5_to_GPE6 = g_GPE_to_GPE * (VGPE6 - vGPE_to_GPE) * sGPE5
    I_GPE5_to_GPE7 = g_GPE_to_GPE * (VGPE7 - vGPE_to_GPE) * sGPE5
    I_GPE5_to_GPE8 = g_GPE_to_GPE * (VGPE8 - vGPE_to_GPE) * sGPE5

    I_GPE6_to_GPE3 = g_GPE_to_GPE * (VGPE3 - vGPE_to_GPE) * sGPE6
    I_GPE6_to_GPE4 = g_GPE_to_GPE * (VGPE4 - vGPE_to_GPE) * sGPE6
    I_GPE6_to_GPE5 = g_GPE_to_GPE * (VGPE5 - vGPE_to_GPE) * sGPE6
    I_GPE6_to_GPE7 = g_GPE_to_GPE * (VGPE7 - vGPE_to_GPE) * sGPE6
    I_GPE6_to_GPE8 = g_GPE_to_GPE * (VGPE8 - vGPE_to_GPE) * sGPE6
    I_GPE6_to_GPE9 = g_GPE_to_GPE * (VGPE9 - vGPE_to_GPE) * sGPE6

    I_GPE7_to_GPE4 = g_GPE_to_GPE * (VGPE4 - vGPE_to_GPE) * sGPE7
    I_GPE7_to_GPE5 = g_GPE_to_GPE * (VGPE5 - vGPE_to_GPE) * sGPE7
    I_GPE7_to_GPE6 = g_GPE_to_GPE * (VGPE6 - vGPE_to_GPE) * sGPE7
    I_GPE7_to_GPE8 = g_GPE_to_GPE * (VGPE8 - vGPE_to_GPE) * sGPE7
    I_GPE7_to_GPE9 = g_GPE_to_GPE * (VGPE9 - vGPE_to_GPE) * sGPE7
    I_GPE7_to_GPE1 = g_GPE_to_GPE * (VGPE1 - vGPE_to_GPE) * sGPE7

    I_GPE8_to_GPE5 = g_GPE_to_GPE * (VGPE5 - vGPE_to_GPE) * sGPE8
    I_GPE8_to_GPE6 = g_GPE_to_GPE * (VGPE6 - vGPE_to_GPE) * sGPE8
    I_GPE8_to_GPE7 = g_GPE_to_GPE * (VGPE7 - vGPE_to_GPE) * sGPE8
    I_GPE8_to_GPE9 = g_GPE_to_GPE * (VGPE9 - vGPE_to_GPE) * sGPE8
    I_GPE8_to_GPE1 = g_GPE_to_GPE * (VGPE1 - vGPE_to_GPE) * sGPE8
    I_GPE8_to_GPE2 = g_GPE_to_GPE * (VGPE2 - vGPE_to_GPE) * sGPE8

    I_GPE9_to_GPE6 = g_GPE_to_GPE * (VGPE6 - vGPE_to_GPE) * sGPE9
    I_GPE9_to_GPE7 = g_GPE_to_GPE * (VGPE7 - vGPE_to_GPE) * sGPE9
    I_GPE9_to_GPE8 = g_GPE_to_GPE * (VGPE8 - vGPE_to_GPE) * sGPE9
    I_GPE9_to_GPE1 = g_GPE_to_GPE * (VGPE9 - vGPE_to_GPE) * sGPE9
    I_GPE9_to_GPE2 = g_GPE_to_GPE * (VGPE1 - vGPE_to_GPE) * sGPE9
    I_GPE9_to_GPE3 = g_GPE_to_GPE * (VGPE2 - vGPE_to_GPE) * sGPE9

    #gpe to stn

    I_GPE1_to_STN8 = g_GPE_to_STN * (VSTN8 - vGPE_to_STN) * sGPE1
    I_GPE1_to_STN9 = g_GPE_to_STN * (VSTN9 - vGPE_to_STN) * sGPE1
    I_GPE1_to_STN1 = g_GPE_to_STN * (VSTN1 - vGPE_to_STN) * sGPE1
    I_GPE1_to_STN2 = g_GPE_to_STN * (VSTN2 - vGPE_to_STN) * sGPE1
    I_GPE1_to_STN3 = g_GPE_to_STN * (VSTN3 - vGPE_to_STN) * sGPE1

    I_GPE2_to_STN9 = g_GPE_to_STN * (VSTN9 - vGPE_to_STN) * sGPE2
    I_GPE2_to_STN1 = g_GPE_to_STN * (VSTN1 - vGPE_to_STN) * sGPE2
    I_GPE2_to_STN2 = g_GPE_to_STN * (VSTN2 - vGPE_to_STN) * sGPE2
    I_GPE2_to_STN3 = g_GPE_to_STN * (VSTN3 - vGPE_to_STN) * sGPE2
    I_GPE2_to_STN4 = g_GPE_to_STN * (VSTN4 - vGPE_to_STN) * sGPE2

    I_GPE3_to_STN1 = g_GPE_to_STN * (VSTN1 - vGPE_to_STN) * sGPE3
    I_GPE3_to_STN2 = g_GPE_to_STN * (VSTN2 - vGPE_to_STN) * sGPE3
    I_GPE3_to_STN3 = g_GPE_to_STN * (VSTN3 - vGPE_to_STN) * sGPE3
    I_GPE3_to_STN4 = g_GPE_to_STN * (VSTN4 - vGPE_to_STN) * sGPE3
    I_GPE3_to_STN5 = g_GPE_to_STN * (VSTN5 - vGPE_to_STN) * sGPE3

    I_GPE4_to_STN2 = g_GPE_to_STN * (VSTN2 - vGPE_to_STN) * sGPE4
    I_GPE4_to_STN3 = g_GPE_to_STN * (VSTN3 - vGPE_to_STN) * sGPE4
    I_GPE4_to_STN4 = g_GPE_to_STN * (VSTN4 - vGPE_to_STN) * sGPE4
    I_GPE4_to_STN5 = g_GPE_to_STN * (VSTN5 - vGPE_to_STN) * sGPE4
    I_GPE4_to_STN6 = g_GPE_to_STN * (VSTN6 - vGPE_to_STN) * sGPE4

    I_GPE5_to_STN3 = g_GPE_to_STN * (VSTN3 - vGPE_to_STN) * sGPE5
    I_GPE5_to_STN4 = g_GPE_to_STN * (VSTN4 - vGPE_to_STN) * sGPE5
    I_GPE5_to_STN5 = g_GPE_to_STN * (VSTN5 - vGPE_to_STN) * sGPE5
    I_GPE5_to_STN6 = g_GPE_to_STN * (VSTN6 - vGPE_to_STN) * sGPE5
    I_GPE5_to_STN7 = g_GPE_to_STN * (VSTN7 - vGPE_to_STN) * sGPE5

    I_GPE6_to_STN4 = g_GPE_to_STN * (VSTN4 - vGPE_to_STN) * sGPE6
    I_GPE6_to_STN5 = g_GPE_to_STN * (VSTN5 - vGPE_to_STN) * sGPE6
    I_GPE6_to_STN6 = g_GPE_to_STN * (VSTN6 - vGPE_to_STN) * sGPE6
    I_GPE6_to_STN7 = g_GPE_to_STN * (VSTN7 - vGPE_to_STN) * sGPE6
    I_GPE6_to_STN8 = g_GPE_to_STN * (VSTN8 - vGPE_to_STN) * sGPE6

    I_GPE7_to_STN5 = g_GPE_to_STN * (VSTN5 - vGPE_to_STN) * sGPE7
    I_GPE7_to_STN6 = g_GPE_to_STN * (VSTN6 - vGPE_to_STN) * sGPE7
    I_GPE7_to_STN7 = g_GPE_to_STN * (VSTN7 - vGPE_to_STN) * sGPE7
    I_GPE7_to_STN8 = g_GPE_to_STN * (VSTN8 - vGPE_to_STN) * sGPE7
    I_GPE7_to_STN9 = g_GPE_to_STN * (VSTN9 - vGPE_to_STN) * sGPE7

    I_GPE8_to_STN6 = g_GPE_to_STN * (VSTN6 - vGPE_to_STN) * sGPE8
    I_GPE8_to_STN7 = g_GPE_to_STN * (VSTN7 - vGPE_to_STN) * sGPE8
    I_GPE8_to_STN8 = g_GPE_to_STN * (VSTN8 - vGPE_to_STN) * sGPE8
    I_GPE8_to_STN9 = g_GPE_to_STN * (VSTN9 - vGPE_to_STN) * sGPE8
    I_GPE8_to_STN1 = g_GPE_to_STN * (VSTN1 - vGPE_to_STN) * sGPE8

    I_GPE9_to_STN7 = g_GPE_to_STN * (VSTN7 - vGPE_to_STN) * sGPE9
    I_GPE9_to_STN8 = g_GPE_to_STN * (VSTN8 - vGPE_to_STN) * sGPE9
    I_GPE9_to_STN9 = g_GPE_to_STN * (VSTN9 - vGPE_to_STN) * sGPE9
    I_GPE9_to_STN1 = g_GPE_to_STN * (VSTN1 - vGPE_to_STN) * sGPE9
    I_GPE9_to_STN2 = g_GPE_to_STN * (VSTN2 - vGPE_to_STN) * sGPE9

    #stn to gpe

    I_STN1_to_GPE9 = g_STN_to_GPE * (VGPE9 - vSTN_to_GPE) * sSTN1
    I_STN1_to_GPE1 = g_STN_to_GPE * (VGPE1 - vSTN_to_GPE) * sSTN1
    I_STN1_to_GPE2 = g_STN_to_GPE * (VGPE2 - vSTN_to_GPE) * sSTN1

    I_STN2_to_GPE1 = g_STN_to_GPE * (VGPE1 - vSTN_to_GPE) * sSTN2
    I_STN2_to_GPE2 = g_STN_to_GPE * (VGPE2 - vSTN_to_GPE) * sSTN2
    I_STN2_to_GPE3 = g_STN_to_GPE * (VGPE3 - vSTN_to_GPE) * sSTN2

    I_STN3_to_GPE2 = g_STN_to_GPE * (VGPE2 - vSTN_to_GPE) * sSTN3
    I_STN3_to_GPE3 = g_STN_to_GPE * (VGPE3 - vSTN_to_GPE) * sSTN3
    I_STN3_to_GPE4 = g_STN_to_GPE * (VGPE4 - vSTN_to_GPE) * sSTN3

    I_STN4_to_GPE3 = g_STN_to_GPE * (VGPE3 - vSTN_to_GPE) * sSTN4
    I_STN4_to_GPE4 = g_STN_to_GPE * (VGPE4 - vSTN_to_GPE) * sSTN4
    I_STN4_to_GPE5 = g_STN_to_GPE * (VGPE5 - vSTN_to_GPE) * sSTN4

    I_STN5_to_GPE4 = g_STN_to_GPE * (VGPE4 - vSTN_to_GPE) * sSTN5
    I_STN5_to_GPE5 = g_STN_to_GPE * (VGPE5 - vSTN_to_GPE) * sSTN5
    I_STN5_to_GPE6 = g_STN_to_GPE * (VGPE6 - vSTN_to_GPE) * sSTN5

    I_STN6_to_GPE5 = g_STN_to_GPE * (VGPE5 - vSTN_to_GPE) * sSTN6
    I_STN6_to_GPE6 = g_STN_to_GPE * (VGPE6 - vSTN_to_GPE) * sSTN6
    I_STN6_to_GPE7 = g_STN_to_GPE * (VGPE7 - vSTN_to_GPE) * sSTN6

    I_STN7_to_GPE6 = g_STN_to_GPE * (VGPE6 - vSTN_to_GPE) * sSTN7
    I_STN7_to_GPE7 = g_STN_to_GPE * (VGPE7 - vSTN_to_GPE) * sSTN7
    I_STN7_to_GPE8 = g_STN_to_GPE * (VGPE8 - vSTN_to_GPE) * sSTN7

    I_STN8_to_GPE7 = g_STN_to_GPE * (VGPE7 - vSTN_to_GPE) * sSTN8
    I_STN8_to_GPE8 = g_STN_to_GPE * (VGPE8 - vSTN_to_GPE) * sSTN8
    I_STN8_to_GPE9 = g_STN_to_GPE * (VGPE9 - vSTN_to_GPE) * sSTN8

    I_STN9_to_GPE8 = g_STN_to_GPE * (VGPE8 - vSTN_to_GPE) * sSTN9
    I_STN9_to_GPE9 = g_STN_to_GPE * (VGPE9 - vSTN_to_GPE) * sSTN9
    I_STN9_to_GPE1 = g_STN_to_GPE * (VGPE1 - vSTN_to_GPE) * sSTN9

    #snc to gpe

    I_SNC1_to_GPE9 = g_STN_to_GPE * (VGPE9 - vSTN_to_GPE) * sSNC1
    I_SNC1_to_GPE1 = g_STN_to_GPE * (VGPE1 - vSTN_to_GPE) * sSNC1
    I_SNC1_to_GPE2 = g_STN_to_GPE * (VGPE2 - vSTN_to_GPE) * sSNC1

    I_SNC2_to_GPE1 = g_STN_to_GPE * (VGPE1 - vSTN_to_GPE) * sSNC2
    I_SNC2_to_GPE2 = g_STN_to_GPE * (VGPE2 - vSTN_to_GPE) * sSNC2
    I_SNC2_to_GPE3 = g_STN_to_GPE * (VGPE3 - vSTN_to_GPE) * sSNC2

    I_SNC3_to_GPE2 = g_STN_to_GPE * (VGPE2 - vSTN_to_GPE) * sSNC3
    I_SNC3_to_GPE3 = g_STN_to_GPE * (VGPE3 - vSTN_to_GPE) * sSNC3
    I_SNC3_to_GPE4 = g_STN_to_GPE * (VGPE4 - vSTN_to_GPE) * sSNC3

    I_SNC4_to_GPE3 = g_STN_to_GPE * (VGPE3 - vSTN_to_GPE) * sSNC4
    I_SNC4_to_GPE4 = g_STN_to_GPE * (VGPE4 - vSTN_to_GPE) * sSNC4
    I_SNC4_to_GPE5 = g_STN_to_GPE * (VGPE5 - vSTN_to_GPE) * sSNC4

    I_SNC5_to_GPE4 = g_STN_to_GPE * (VGPE4 - vSTN_to_GPE) * sSNC5
    I_SNC5_to_GPE5 = g_STN_to_GPE * (VGPE5 - vSTN_to_GPE) * sSNC5
    I_SNC5_to_GPE6 = g_STN_to_GPE * (VGPE6 - vSTN_to_GPE) * sSNC5

    I_SNC6_to_GPE5 = g_STN_to_GPE * (VGPE5 - vSTN_to_GPE) * sSNC6
    I_SNC6_to_GPE6 = g_STN_to_GPE * (VGPE6 - vSTN_to_GPE) * sSNC6
    I_SNC6_to_GPE7 = g_STN_to_GPE * (VGPE7 - vSTN_to_GPE) * sSNC6

    I_SNC7_to_GPE6 = g_STN_to_GPE * (VGPE6 - vSTN_to_GPE) * sSNC7
    I_SNC7_to_GPE7 = g_STN_to_GPE * (VGPE7 - vSTN_to_GPE) * sSNC7
    I_SNC7_to_GPE8 = g_STN_to_GPE * (VGPE8 - vSTN_to_GPE) * sSNC7

    I_SNC8_to_GPE7 = g_STN_to_GPE * (VGPE7 - vSTN_to_GPE) * sSNC8
    I_SNC8_to_GPE8 = g_STN_to_GPE * (VGPE8 - vSTN_to_GPE) * sSNC8
    I_SNC8_to_GPE9 = g_STN_to_GPE * (VGPE9 - vSTN_to_GPE) * sSNC8

    I_SNC9_to_GPE8 = g_STN_to_GPE * (VGPE8 - vSTN_to_GPE) * sSNC9
    I_SNC9_to_GPE9 = g_STN_to_GPE * (VGPE9 - vSTN_to_GPE) * sSNC9
    I_SNC9_to_GPE1 = g_STN_to_GPE * (VGPE1 - vSTN_to_GPE) * sSNC9


    output = [0] * 162

    output[0] = (-ILSTN1 - IKSTN1 - INaSTN1 - ITSTN1 - ICaSTN1 - IAHPSTN1 - I_GPE8_to_STN1 - I_GPE9_to_STN1 - I_GPE1_to_STN1 - I_GPE2_to_STN1 - I_GPE3_to_STN1)/C_m
    ...
    output[6] = (-ILSTN2 - IKSTN2 - INaSTN2 - ITSTN2 - ICaSTN2 - IAHPSTN2 - I_GPE9_to_STN2 - I_GPE1_to_STN2 - I_GPE2_to_STN2 - I_GPE3_to_STN2 - I_GPE4_to_STN2)/C_m
    ...
    output[12] = (-ILSTN3 - IKSTN3 - INaSTN3 - ITSTN3 - ICaSTN3 - IAHPSTN3 - I_GPE1_to_STN3 - I_GPE2_to_STN3 - I_GPE3_to_STN3 - I_GPE4_to_STN3 - I_GPE5_to_STN3)/C_m
    ...
    output[18] = (-ILSTN4 - IKSTN4 - INaSTN4 - ITSTN4 - ICaSTN4 - IAHPSTN4 - I_GPE2_to_STN4 - I_GPE3_to_STN4 - I_GPE4_to_STN4 - I_GPE5_to_STN4 - I_GPE6_to_STN4)/C_m
    ...
    output[24] = (-ILSTN5 - IKSTN5 - INaSTN5 - ITSTN5 - ICaSTN5 - IAHPSTN5 - I_GPE3_to_STN5 - I_GPE4_to_STN5 - I_GPE5_to_STN5 - I_GPE6_to_STN5 - I_GPE7_to_STN5)/C_m
    ...
    output[30] = (-ILSTN6 - IKSTN6- INaSTN6 - ITSTN6 - ICaSTN6 - IAHPSTN6 - I_GPE4_to_STN6 - I_GPE5_to_STN6 - I_GPE6_to_STN6 - I_GPE7_to_STN6 - I_GPE8_to_STN6)/C_m
    ...
    output[36] = (-ILSTN7 - IKSTN7 - INaSTN7 - ITSTN7 - ICaSTN7 - IAHPSTN7 - I_GPE5_to_STN7 - I_GPE6_to_STN7 - I_GPE7_to_STN7 - I_GPE8_to_STN7 - I_GPE9_to_STN7)/C_m
    ...
    output[42] = (-ILSTN8 - IKSTN8 - INaSTN8 - ITSTN8 - ICaSTN8 - IAHPSTN8 - I_GPE6_to_STN8 - I_GPE7_to_STN8 - I_GPE8_to_STN8 - I_GPE9_to_STN8 - I_GPE1_to_STN8)/C_m
    ...
    output[48] = (-ILSTN9 - IKSTN9 - INaSTN9 - ITSTN9 - ICaSTN9 - IAHPSTN9 - I_GPE7_to_STN9 - I_GPE8_to_STN9 - I_GPE9_to_STN9 - I_GPE1_to_STN9 - I_GPE2_to_STN9)/C_m
    ...
    output[54] = (-ILGPE1 - IKGPE1 - INaGPE1 - ITGPE1 - ICaGPE1 - IAHPGPE1 - I_GPE2_to_GPE1 - I_GPE3_to_GPE1 - I_GPE4_to_GPE1 - I_GPE7_to_GPE1 - I_GPE8_to_GPE1 - I_GPE9_to_GPE1 - I_STN1_to_GPE1 - I_STN2_to_GPE1 - I_STN9_to_GPE1 - I_SNC1_to_GPE1 - I_SNC2_to_GPE1 - I_SNC9_to_GPE1)/C_m
    ...
    output[60] = (-ILGPE2 - IKGPE2 - INaGPE2 - ITGPE2 - ICaGPE2 - IAHPGPE2 - I_GPE1_to_GPE2 - I_GPE3_to_GPE2 - I_GPE4_to_GPE2 - I_GPE5_to_GPE2 - I_GPE8_to_GPE2 - I_GPE9_to_GPE2 - I_STN1_to_GPE2 - I_STN2_to_GPE2 - I_STN3_to_GPE2 - I_SNC1_to_GPE2 - I_SNC2_to_GPE2 - I_SNC3_to_GPE2)/C_m
    ...
    output[66] = (-ILGPE3 - IKGPE3 - INaGPE3 - ITGPE3 - ICaGPE3 - IAHPGPE3- I_GPE1_to_GPE3 - I_GPE2_to_GPE3 - I_GPE4_to_GPE3 - I_GPE5_to_GPE3 - I_GPE6_to_GPE3 - I_GPE9_to_GPE3 - I_STN2_to_GPE3 - I_STN3_to_GPE3 - I_STN4_to_GPE3 - I_SNC2_to_GPE3 - I_SNC3_to_GPE3 - I_SNC4_to_GPE3)/C_m
    ...
    output[72] = (-ILGPE4 - IKGPE4 - INaGPE4 - ITGPE4 - ICaGPE4 - IAHPGPE4 - I_GPE1_to_GPE4 - I_GPE2_to_GPE4 - I_GPE3_to_GPE4 - I_GPE5_to_GPE4 - I_GPE6_to_GPE4 - I_GPE7_to_GPE4 - I_STN3_to_GPE4 - I_STN4_to_GPE4 - I_STN5_to_GPE4 - I_SNC3_to_GPE4 - I_SNC4_to_GPE4 - I_SNC5_to_GPE4)/C_m
    ...
    output[78] = (-ILGPE5 - IKGPE5 - INaGPE5 - ITGPE5 - ICaGPE5 - IAHPGPE5 - I_GPE2_to_GPE5 - I_GPE3_to_GPE5 - I_GPE4_to_GPE5 - I_GPE6_to_GPE5 - I_GPE7_to_GPE5 - I_GPE8_to_GPE5 - I_STN4_to_GPE5 - I_STN5_to_GPE5 - I_STN6_to_GPE5 - I_SNC4_to_GPE5 - I_SNC5_to_GPE5 - I_SNC6_to_GPE5)/C_m
    ...
    output[84] = (-ILGPE6 - IKGPE6 - INaGPE6 - ITGPE6 - ICaGPE6 - IAHPGPE6 - I_GPE3_to_GPE6 - I_GPE4_to_GPE6 - I_GPE5_to_GPE6 - I_GPE7_to_GPE6 - I_GPE8_to_GPE6 - I_GPE9_to_GPE6 - I_STN5_to_GPE6 - I_STN6_to_GPE6 - I_STN7_to_GPE6 - I_SNC5_to_GPE6 - I_SNC6_to_GPE6 - I_SNC7_to_GPE6)/C_m
    ...
    output[90] = (-ILGPE7 - IKGPE7 - INaGPE7 - ITGPE7 - ICaGPE7 - IAHPGPE7 - I_GPE1_to_GPE7 - I_GPE4_to_GPE7 - I_GPE5_to_GPE7 - I_GPE6_to_GPE7 - I_GPE8_to_GPE7 - I_GPE9_to_GPE7 - I_STN6_to_GPE7 - I_STN7_to_GPE7 - I_STN8_to_GPE7 - I_SNC6_to_GPE7 - I_SNC7_to_GPE7 - I_SNC8_to_GPE7)/C_m
    ...
    output[96] = (-ILGPE8 - IKGPE8 - INaGPE8 - ITGPE8 - ICaGPE8 - IAHPGPE8 - I_GPE1_to_GPE8 - I_GPE2_to_GPE8 - I_GPE5_to_GPE8 - I_GPE6_to_GPE8 - I_GPE7_to_GPE8 - I_GPE9_to_GPE8 - I_STN7_to_GPE8 - I_STN8_to_GPE8 - I_STN9_to_GPE8 - I_SNC7_to_GPE8 - I_SNC8_to_GPE8 - I_SNC9_to_GPE8)/C_m
    ...
    output[102] = (-ILGPE9 - IKGPE9 - INaGPE9 - ITGPE9 - ICaGPE9 - IAHPGPE9 - I_GPE1_to_GPE9 - I_GPE2_to_GPE9 - I_GPE3_to_GPE9 - I_GPE6_to_GPE9 - I_GPE7_to_GPE9 - I_GPE8_to_GPE9 - I_STN8_to_GPE9 - I_STN9_to_GPE9 - I_STN1_to_GPE9 - I_SNC8_to_GPE9 - I_SNC9_to_GPE9 - I_SNC1_to_GPE9)/C_m
